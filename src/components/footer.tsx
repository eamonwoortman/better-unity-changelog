...
export const Footer: FunctionComponent = () => <footer className="text-gray-700 bg-black body-font">
    <div className="container flex flex-col items-center px-8 py-8 mx-auto max-w-7xl sm:flex-row">
      <p className="text-sm text-gray-500">© 2021 - Eamon Woortman</p>
