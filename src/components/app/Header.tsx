...
export const Header: FunctionComponent = () => <header>
    <section className="relative w-full px-8 text-gray-700 bg-black body-font">
        <div className="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
          <div className="relative z-10 flex items-center w-auto text-2xl font-extrabold leading-none text-black select-none"><img src={UnityLogo} className="App-logo" alt="logo" /></div>
